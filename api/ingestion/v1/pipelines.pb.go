...
type PipelineEdge struct {
	...
	Transform     *structpb.Struct `protobuf:"bytes,8,opt,name=transform,proto3" json:"transform,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetPipelineRequest struct {
	...
	IncludeLastRun  bool                   `protobuf:"varint,3,opt,name=include_last_run,json=includeLastRun,proto3" json:"include_last_run,omitempty"`
	IncludeSchedule bool                   `protobuf:"varint,4,opt,name=include_schedule,json=includeSchedule,proto3" json:"include_schedule,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type ListPipelineVersionsRequest struct {
	...
	Sorting       *SortingRequest        `protobuf:"bytes,3,opt,name=sorting,proto3" json:"sorting,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListPipelinesRequest struct {
	...
	Sorting         *SortingRequest        `protobuf:"bytes,7,opt,name=sorting,proto3" json:"sorting,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_ingestion_v1_pipelines_proto_rawDesc = "" +
	...
	"\n" +
	"write_mode\x18\a \x01(\x0e2\x17.ingestion.v1.WriteModeR\twriteMode\x125\n" +
	"\ttransform\x18\b \x01(\v2\x17.google.protobuf.StructR\ttransform\"s\n" +
	...
	"\x05graph\x18\x04 \x01(\v2\x1b.ingestion.v1.PipelineGraphR\x05graph\x12\x1d\n" +
	"\n" +
	...
	"\bschedule\x18\x01 \x01(\v2\x1e.ingestion.v1.PipelineScheduleR\bschedule\"r\n" +
	...
	"\x10include_last_run\x18\x03 \x01(\bR\x0eincludeLastRun\x12)\n" +
	"\x10include_schedule\x18\x04 \x01(\bR\x0fincludeSchedule\"I\n" +
	...
	"\aversion\x18\x01 \x01(\v2\x1d.ingestion.v1.PipelineVersionR\aversion\"\xb7\x01\n" +
	...
	"pagination\x126\n" +
	"\asorting\x18\x03 \x01(\v2\x1c.ingestion.v1.SortingRequestR\asorting\"\x9b\x01\n" +
	...
	"\x10include_schedule\x18\x05 \x01(\bR\x0fincludeSchedule\x12\x16\n" +
	"\x06search\x18\x06 \x01(\tR\x06search\x126\n" +
	"\asorting\x18\a \x01(\v2\x1c.ingestion.v1.SortingRequestR\asorting\"\x8f\x01\n" +
...
var file_ingestion_v1_pipelines_proto_depIdxs = []int32{
	...
	35, // 27: ingestion.v1.UpdatePipelineRequest.worker_configuration:type_name -> ingestion.v1.WorkerConfiguration
	...
	36, // 31: ingestion.v1.ListPipelineVersionsRequest.pagination:type_name -> ingestion.v1.PaginationRequest
	37, // 32: ingestion.v1.ListPipelineVersionsRequest.sorting:type_name -> ingestion.v1.SortingRequest
	5,  // 33: ingestion.v1.ListPipelineVersionsResponse.versions:type_name -> ingestion.v1.PipelineVersion
	38, // 34: ingestion.v1.ListPipelineVersionsResponse.pagination:type_name -> ingestion.v1.PaginationResponse
	36, // 35: ingestion.v1.ListPipelinesRequest.pagination:type_name -> ingestion.v1.PaginationRequest
	37, // 36: ingestion.v1.ListPipelinesRequest.sorting:type_name -> ingestion.v1.SortingRequest
	6,  // 37: ingestion.v1.ListPipelinesResponse.pipelines:type_name -> ingestion.v1.Pipeline
	38, // 38: ingestion.v1.ListPipelinesResponse.pagination:type_name -> ingestion.v1.PaginationResponse
