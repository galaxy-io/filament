...
type Pipeline struct {
	...
	Execution     ExecutionMode `protobuf:"varint,16,opt,name=execution,proto3,enum=ingestion.v1.ExecutionMode" json:"execution,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Pipeline) GetExecution() ExecutionMode {
	if x != nil {
		return x.Execution
	}
...
type CreatePipelineRequest struct {
	...
	Execution     ExecutionMode `protobuf:"varint,5,opt,name=execution,proto3,enum=ingestion.v1.ExecutionMode" json:"execution,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreatePipelineRequest) GetExecution() ExecutionMode {
	if x != nil {
		return x.Execution
	}
	return ExecutionMode_EXECUTION_MODE_UNSPECIFIED
...
func (x *UpdatePipelineRequest) GetExecution() ExecutionMode {
	if x != nil {
		return x.Execution
	}
	return ExecutionMode_EXECUTION_MODE_UNSPECIFIED
...
const file_ingestion_v1_pipelines_proto_rawDesc = "" +
	...
	"\x12deleted_by_user_id\x18\b \x01(\tR\x0fdeletedByUserId\"\xd3\x05\n" +
	"\bPipeline\x12\x1b\n" +
	...
	"\x14worker_configuration\x18\x0f \x01(\v2!.ingestion.v1.WorkerConfigurationR\x13workerConfiguration\x129\n" +
	"\texecution\x18\x10 \x01(\x0e2\x1b.ingestion.v1.ExecutionModeR\texecution\"\xbb\x01\n" +
	...
	"nextFireAt\x12\"\n" +
	"\rlast_fired_at\x18\x05 \x01(\x03R\vlastFiredAt\"\xa0\x02\n" +
	...
	"\x14worker_configuration\x18\x04 \x01(\v2!.ingestion.v1.WorkerConfigurationR\x13workerConfiguration\x129\n" +
	"\texecution\x18\x05 \x01(\x0e2\x1b.ingestion.v1.ExecutionModeR\texecution\"\x88\x01\n" +
	...
	"\aversion\x18\x01 \x01(\v2\x1d.ingestion.v1.PipelineVersionR\aversion\"\xff\x01\n" +
	...
	"\x14worker_configuration\x18\x04 \x01(\v2!.ingestion.v1.WorkerConfigurationR\x13workerConfiguration\x129\n" +
	"\texecution\x18\x05 \x01(\x0e2\x1b.ingestion.v1.ExecutionModeR\texecution\"L\n" +
...
var file_ingestion_v1_pipelines_proto_depIdxs = []int32{
	...
	36, // 14: ingestion.v1.Pipeline.execution:type_name -> ingestion.v1.ExecutionMode
	...
	36, // 19: ingestion.v1.CreatePipelineRequest.execution:type_name -> ingestion.v1.ExecutionMode
	...
	36, // 29: ingestion.v1.UpdatePipelineRequest.execution:type_name -> ingestion.v1.ExecutionMode
