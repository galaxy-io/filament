...
export const PIPELINE_METRIC_COLUMN_WIDTH_LAST_RUN = 130;
export const PIPELINE_METRIC_COLUMN_WIDTH_VOLUME = 110;
export const PIPELINE_METRIC_COLUMN_WIDTH_SCHEDULE = 100;
