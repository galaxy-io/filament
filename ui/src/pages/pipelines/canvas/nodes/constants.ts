...
export const PIPELINE_CANVAS_NODE_PORT_SIZE_ACTIVE = 12;
export const PIPELINE_CANVAS_NODE_PORT_SIZE_IDLE = 5;
export const PIPELINE_CANVAS_NODE_TABLE_LIST_MAX_HEIGHT = 300;
export const PIPELINE_CANVAS_NODE_TABLE_LIST_SHIMMER_COUNT = 5;
...
export const CONNECTOR_KIND_TO_PLACEHOLDER_DESCRIPTION_MAP: Record<ConnectorKind, string> = {
