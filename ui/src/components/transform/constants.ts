...
export const TRANSFORM_COPY_ACTION = "copy";
...
export const TRANSFORM_LITERAL_KIND_TO_ACTION_MAP: Record<TransformLiteralKind, string> = {
  [TransformLiteralKind.STRING]: "literal:string",
  [TransformLiteralKind.NUMBER]: "literal:number",
  [TransformLiteralKind.BOOLEAN]: "literal:boolean",
};
export const TRANSFORM_ACTION_TO_LITERAL_KIND_MAP = new Map<string, TransformLiteralKind>(
  TRANSFORM_LITERAL_KINDS.map((kind) => [TRANSFORM_LITERAL_KIND_TO_ACTION_MAP[kind], kind]),
);
...
export const TRANSFORM_STEP_KIND_TO_LABEL_MAP: Record<
  Exclude<TransformStepKind, TransformStepKind.COMPUTE>,
  string
> = {
  [TransformStepKind.RENAME]: "Rename",
  [TransformStepKind.DROP]: "Drop",
  [TransformStepKind.RAW]: TRANSFORM_RAW_STEP_LABEL,
};

export const TRANSFORM_CONDITION_JOIN_TO_FUNCTION_MAP: Record<
  TransformConditionJoin,
  TransformFunction["name"]
> = {
  [TransformConditionJoin.AND]: "and",
  [TransformConditionJoin.OR]: "or",
};
...
export const TRANSFORM_FUNCTION_ORDER_MAP = new Map<TransformFunction["name"], number>(
  [
    "lower",
    "upper",
    "trim",
