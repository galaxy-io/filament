...
import PipelineTransformFieldsStepItem from "@/components/transform/PipelineTransformFieldsStepItem";

const NO_ISSUES: string[] = [];
const LABEL_INSET = TRANSFORM_HEADER_PADDING_X + TRANSFORM_HANDLE + TRANSFORM_GAP;
  ...
  return (
    <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
      ...
      >
        {resources.length > 1 && (
          <FlexWrapper
            padding={`${TRANSFORM_GAP}px ${TRANSFORM_HEADER_PADDING_X}px 0 ${LABEL_INSET}px`}
          >
