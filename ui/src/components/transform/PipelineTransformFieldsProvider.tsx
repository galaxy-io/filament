...
} from "@/components/transform/reducer";
import type {
...
const PipelineTransformFieldsEditorContext = createContext<PipelineTransformFieldsEditor | null>(
  null,
);
PipelineTransformFieldsEditorContext.displayName = "PipelineTransformFieldsEditorContext";

export const PipelineTransformFieldsEditorProvider = PipelineTransformFieldsEditorContext.Provider;
