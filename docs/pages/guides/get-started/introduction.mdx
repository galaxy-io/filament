...
<Frame caption="Welcome to Filament">
  <div className="w-full">
    <div className="hidden md:block">
      <iframe
        src="https://cdn.getgalaxy.io/filament/filament-product-demo-light.html"
      ...
      />
      <iframe
        src="https://cdn.getgalaxy.io/filament/filament-product-demo-dark.html"
        title="Filament onboarding walkthrough"
    ...
    <div className="block md:hidden">
      <iframe
        src="https://cdn.getgalaxy.io/filament/filament-product-demo-mobile-light.html"
        title="Filament onboarding walkthrough"
        className="block dark:hidden w-full rounded-xl"
        style={{ height: "700px", border: 0, colorScheme: "light" }}
      />
      <iframe
        src="https://cdn.getgalaxy.io/filament/filament-product-demo-mobile-dark.html"
        title="Filament onboarding walkthrough"
        className="hidden dark:block w-full rounded-xl"
