...
<video
  ...
  loop
  playsInline
  className="w-full rounded-2xl border border-gray-950/10 dark:border-white/10"
  src="https://cdn.getgalaxy.io/filament/introduction.mp4"
></video>
...
<Frame caption="Welcome to Filament">
  <div className="w-full">
    ...
    />
    <iframe
      src="/assets/introduction-mobile.html"
      title="Filament onboarding walkthrough"
