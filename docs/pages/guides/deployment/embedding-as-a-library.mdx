...
By default, state and events stay in memory, so they disappear when the process
restarts. You can replace those defaults with Postgres and NATS for durability.
