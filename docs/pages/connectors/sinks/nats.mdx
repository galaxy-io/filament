...
| `subject` | Pipeline | Either subject or prefix | Fixed subject for all records |
| `subject_prefix` | Pipeline | Either subject or prefix | Publishes to `<prefix>.<destination resource>` |
