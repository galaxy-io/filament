...
<CardGroup cols={2}>
  ...
  <Card title="HubSpot" icon="https://cdn.getgalaxy.io/sources/source-icon-hubspot-dark.svg" href="/pages/connectors/sources/hubspot" />
...
<Info>
  ...
  `connectors/http/manifests/*.yaml` are seven worked examples.
</Info>
