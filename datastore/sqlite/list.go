...
const pipelineColumns = `id, tenant_id, name, description, current_version_id, execution_mode, worker_configuration, created_at, updated_at, deleted_at, coalesce(created_by_user_id, ''), coalesce(updated_by_user_id, ''), coalesce(deleted_by_user_id, '')`
