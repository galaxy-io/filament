...
//
//	func init() {
//	    registry.RegisterSource("postgres", func() filament.Source { return NewSource() })
//	    registry.RegisterSink("postgres",   func() filament.Sink   { return NewSink() })
//	}
//
...
func RegisterSource(name string, f filament.SourceFactory) {
...
func RegisterSink(name string, f filament.SinkFactory) {
